...
urlpatterns = [
    ...
    path('invitations/<int:pk>/accept/', InvitationViewSet.as_view({'post': 'accept'}), name='invitation-accept'),
    path('invitations/<int:pk>/decline/', InvitationViewSet.as_view({'post': 'decline'}), name='invitation-decline'),
] + router.urls